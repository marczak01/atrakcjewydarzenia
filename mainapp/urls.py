...
urlpatterns = [
    ...
    path('selected/<str:selected>', views.home, name='home_selected'),
    ...
    path('events/events-by-weekday/<str:weekday>/', views.events, name='events_by_weekday'),
    ...
    path('event/<int:event>/ratings/', views.event_ratings, name='event_ratings'),
